...
public class Plip extends Creature {
    ...
    private static final double MOVE_ENERGY_LOSE = 0.15;
    private static final double STAY_ENERGY_GAIN = 0.2;
    private static final double ENERGY_CAP = 2.0;
    ...
    public Plip replicate() {
        ...
        return new Plip(REP_ENERGY_GIVEN_RATIO * energy);
    }
    ...
    public Action chooseAction(Map<Direction, Occupant> neighbors) {
        ...
        if (cloruses.size() > 0 && HugLifeUtils.random() < MOVE_PROBABILITY) {
